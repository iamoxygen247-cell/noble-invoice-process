...
def field_gate_from_summary(
    ...
    if field_name in (
        ...
        "pst_amount_extract", "pst_amount_generate",
        ...
        "invoice_date_extract", "invoice_date_generate",
        "billing_period_start_date_extract", "billing_period_start_date_generate",
        "billing_period_end_date_extract", "billing_period_end_date_generate",
        "number_of_days_extract", "number_of_days_generate",
    ):
        if entry is None:
...
def build_scorecard_pairs(
    ...
    # sub_bill_type sits with the lead classification block, right below review_reasons.
    emit_field("sub_bill_type")
    emit_field("sub_bill_type_generate")
